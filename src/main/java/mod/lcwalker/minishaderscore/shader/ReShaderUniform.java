...
public class ReShaderUniform {
    ...
    private void uploadInt() {
        ...
        switch (this.type) {
            case 0:
                OpenGlHelper.glUniform1(this.location, this.intBuffer);
                break;
            case 1:
                OpenGlHelper.glUniform2(this.location, this.intBuffer);
                break;
            case 2:
                OpenGlHelper.glUniform3(this.location, this.intBuffer);
                break;
            case 3:
                OpenGlHelper.glUniform4(this.location, this.intBuffer);
                break;
            default:  
        }
    }
    ...
    private void uploadFloat() {
        ...
        switch (this.type) {
            case 4:
                OpenGlHelper.glUniform1(this.location, this.floatBuffer);
                break;
            case 5:
                OpenGlHelper.glUniform2(this.location, this.floatBuffer);
                break;
            case 6:
                OpenGlHelper.glUniform3(this.location, this.floatBuffer);
                break;
            case 7:
                OpenGlHelper.glUniform4(this.location, this.floatBuffer);
                break;
            default:
    ...
    private void uploadFloatMatrix() {
        ...
        switch (this.type) {
            case 8:
                OpenGlHelper.glUniformMatrix2(this.location, true, this.floatBuffer);
                break;
            case 9:
                OpenGlHelper.glUniformMatrix3(this.location, true, this.floatBuffer);
                break;
            case 10:
                OpenGlHelper.glUniformMatrix4(this.location, true, this.floatBuffer);
        }
    }
}